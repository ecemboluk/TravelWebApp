...
<div id="gezipanel" class="panel panel-default">
  ...
  <div class="panel-body">
    <form action="TravelSession.jsp" method="post">
    <div id="f_title">Seyehat Yeri</div>
    <input id="f_box" type="text" class="form-control" name="seyehatyeri"/>
    <br>
    <div id="f_title">Gidiş Amacı</div>
    <input id="f_box" type="text" class="form-control" name="gidisamaci"/>
     <br>
    <div id="f_title">Proje Kodu</div>
    <input id="f_box" type="text" class="form-control" name="projekodu" />
     <br>
